...
const ContactPage = ({actionData}:Route.ComponentProps) => {
  ...
  return(
      <div className='max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900'>
          ...
          <form action='https://formspree.io/f/xgvgzvod' method='POST' className='space-y-6'>
          <div>
          ...
          <div>
              <label htmlFor="subject" className='block text-sm font-medium text-gray-300'>Message</label>
